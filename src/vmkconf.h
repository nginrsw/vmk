...
@@ VMK_NUMBER_FMT is the format for writing floats.
@@ vmk_number2str converts a float to a string.
...
#define vmk_number2str(s,sz,n)  \
	l_sprintf((s), sz, VMK_NUMBER_FMT, (VMKI_UACNUMBER)(n))
...
#include <assert.h>
#define vmki_apicheck(l,e)	assert(e)
#endif
